...
var log = function () {
    ...
    authRef.authWithCustomToken(firebaseSecret, (err) => {
        ...
        emitter.start();
        emitter.on("create", function (container) {
            let receivedLoggerId = _.get(container, "Actor.Attributes.loggerId");
            let receivedFirebaseUrl = _.get(container, "Actor.Attributes.firebaseUrl");
